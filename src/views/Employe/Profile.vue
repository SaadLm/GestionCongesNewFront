  ...
  <main>
    ...
    <div class="py-5 container-fluid">
      <div class="row">
        ...
        <div class="col-md-2 col-sm-8 mt-5 ms-sm-1 mb-10">
...
<!--                  <argon-input type="text" value="lucky.jesse" />-->
                    <input type="text" class="formbold-form-input" v-model="employe.nom" disabled>
                </div>
                <div class="col-md-6">
                  <label for="example-text-input" class="form-control-label"
                    >Email :</label
                  >
                  <input type="email" v-model="employe.email" class="formbold-form-input" disabled>
                </div>
                <div class="col-md-6">
                  <label for="example-text-input" class="form-control-label"
                    >Nom :</label
                  >
                  <input class="form-control" type="text" v-model="employe.nom" disabled/>
                </div>
                <div class="col-md-6">
                  <label for="example-text-input" class="form-control-label"
                    >Prenom :</label
                  >
                  <input class="form-control" type="text" v-model="employe.prenom" disabled/>
                </div>
              </div>
...
<!--                  >-->
<!--                  <input-->
<!--                    type="text" value="A beautiful Dashboard for Bootstrap 5. It is Free and Open Source." class="formbold-form-input" disabled>-->
<!--                </div>-->
                <div class="col-md-4 offset-4 mt-2">
                    <label for="example-text-input" class="form-control-label">Solde de congé</label>
                    <span class="ms-3 fw-bolder">{{ employe.soldeConge }}</span><span class="ms-2">jrs</span>
                </div>
