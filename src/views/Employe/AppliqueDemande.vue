...
<template>
    <div class="container-fluid mt-5">
        <div class="row">
            <div class="col-md-3 col-sm-8 mt-5 ms-sm-1 me-5">
...
<!--                                        <span>{{ demande.dateDebut}}</span>-->
                                      <flat-pickr
                                              ...
                                              @change="updateMaxDate"
                                              class="form-control form-control-sm w-100 cursor-pointer"
                                      ></flat-pickr>
                                    </div>
                                    <div class="col-md-6">
                                      ...
                                      <flat-pickr
                                              ...
                                              @change="changeDuree"
                                              class="form-control form-control-sm w-100 ms-md-4 cursor-pointer"
                                      ></flat-pickr>
                                    </div>
